...
function Inputs(props) {
  ...
  return (
    <>
      <InputsTitle>
        Please select the correct configuration options for your system.
      </InputsTitle>
      <InputsForm>
        <InputsLabel>
          Model Type:
        ...
        <InputsLabel>
          ...
          >
            ...
            <option value="Private Infrastructure">
              Private Infrastructure
            </option>
          </InputsSelect>
        </InputsLabel>
        {config.provider !== "Private Infrastructure" ? (
          <InputsLabel>
            Region:
            <InputsSelect
              value={config.region}
            ...
            >
              {sources.map((source) =>
                source.provider === config.provider ? (
                  <option value={source.region}>{source.region}</option>
                ) : null
              )}
            </InputsSelect>
          </InputsLabel>
